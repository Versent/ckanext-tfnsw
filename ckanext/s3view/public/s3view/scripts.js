function s3View(s3exp_config) {
  console.log(s3exp_config);
    ...
    return {
      ...
      cb: function (err, data) {
        if (err) {
          ...
          console.log(
            "Options: " + $("input[name='optionsdepth']:checked").val()
          );
          ...
          $("#badgecount").text(
            scope.Contents.length + scope.CommonPrefixes.length
          );
          ...
          if (scope.stop) {
            ...
            console.log(
              "Bucket " +
                scope.params.Bucket +
                " has " +
                scope.Contents.length +
                " objects, including " +
                scope.CommonPrefixes.length +
                " prefixes"
            );
  ...
  function resetDepth() {
    ...
    $('input[name="optionsdepth"][value="bucket"]')
      .parent()
      .removeClass("active");
  ...
  $(document).ready(function () {
    ...
    $("input:radio[name='optionsdepth']").change(function () {
      ...
      console.log(
        "Change options: " + $("input[name='optionsdepth']:checked").val()
      );
    ...
    $("#tb-s3objects").DataTable({
      ...
      aoColumnDefs: [
        ...
        },
        {
          ...
          mRender: function (data, type, full) {
            return data
              ? moment(data).local().format("YYYY-MM-DD HH:mm:ss")
              : "";
          },
        },
        {
    ...
    $("#tb-s3objects").on("click", "a", function (event) {
      ...
      if (target.dataset.s3 === "folder") {
        ...
        s3exp_config.Delimiter =
          $("input[name='optionsdepth']:checked").val() == "folder" ? "/" : "";
        (s3exp_lister = s3list(s3exp_config, s3draw)).go();
